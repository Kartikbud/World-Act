...
def make(env_name, *args, **kwargs):
    # gym>=0.24 wraps envs with a passive checker that requires obs keys to
    # exactly match observation_space. roboverse returns extra keys
    # (object_position / object_orientation), so disable the checker.
